...
IMAGE_BY_SLUG = {
    ...
    "security-scale-hybrid": ("03-security-scale-hybrid.png", "Defense in depth — Kuadrant, ambient mesh, ACS, and NetworkPolicy"),
    ...
    "acm-multicluster": ("10-acm-multicluster.png", "ACM multicluster fleet — hub governing east and west OpenShift spokes"),
    "hybrid-mesh-architecture": ("11-hybrid-mesh.png", "Hybrid mesh — Gateway API on hub, Skupper tunnels to spoke services"),
    ...
    "scalability": ("18-scalability.png", "Three-tier scaling — Kairos nodes, HPA pods, Kafka buffering"),
    "network-policies": ("19-network-policies.png", "OVN-Kubernetes NetworkPolicy micro-segmentation for IE dashboard"),
    "acs-kuadrant": ("20-acs-kuadrant.png", "ACS runtime security plus Kuadrant API management at hub gateway"),
    ...
    "mcp-gateway": ("24-mcp-gateway.png", "MCP Gateway — federated Argo CD and Kubernetes tools for Lightspeed"),
    "llm-rag": ("25-llm-rag.png", "LLM + RAG — factory runbooks via governed MaaS"),
    "neuroface": ("27-neuroface.png", "NeuroFace — OVMS vision plus MaaS chat for factory operators"),
    "ai-end-user-apps": ("28-ai-end-user-apps.png", "AI embedded in factory operator apps — dashboard and alerts"),
    "full-verification": ("29-full-verification.png", "Full-stack verification — hub, spokes, mesh, GitOps, security, AI"),
}
...
{banner}{MODULE_CONTEXT[slug].strip()}
"""
...
""",
    ...
    for item in MODULES:
        ...
        narrative = NARRATIVES[slug].strip()
